...
namespace seng301_asgn1
{
    ...
    public class VendingMachineFactory : IVendingMachineFactory
    {
        ...
        public void pressButton(int vmIndex, int value)
        {
            // TODO: Implement
            coinKinds.Sort();
            List<Coin> removeCoinList = new List<Coin>();
            ...
            if (balance >= popCosts[value])
            {
                ...
                int current = 0;
                /*
               while(counters < coinChute.Count)
                {
                    foreach (Coin i in coinChute[counters])
                    {
                ...
                */               
                ...
                if (returnValueInChange > 0)
                {
                    ...
                    foreach(Coin i in removeCoinList)
                    {
                        fullCoins.Remove(i);
                    }
                }
